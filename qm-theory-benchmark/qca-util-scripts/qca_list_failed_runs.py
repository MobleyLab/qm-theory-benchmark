...
@click.command()
@click.option("--dataset", type=click.STRING, default="None", help="name the dataset")
@click.option(
    "--type", type=click.STRING, default="None", help="type of dataset, OPT, TD, HESS"
)
@click.option(
    "--spec", type=click.STRING, default="default", help="compute spec to check"
)
